...
class GreedyWorker():
    ...
    def evaluate_initial(self):
        ...
        # iverlog_command = [self.path['iverilog'], '-o', self.modulename+'.iv', self.input, self.testbench]
        iverlog_command = [self.path['iverilog'], '-o', self.modulename+'.iv', self.testbench, self.input]
        subprocess.call(iverlog_command)
        ...
        # print(iverlog_command)
        # print(vvp_command)
        # print("Iverilog called")
        # time.sleep(10)
